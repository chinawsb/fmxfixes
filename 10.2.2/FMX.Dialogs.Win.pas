...
uses
  ...
  FMX.Platform.Win, FMX.DialogHelper;
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            CreateButton(Data, IDRETRY, SMsgDlgYestoAll);
            CreateButton(Data, IDIGNORE, SMsgDlgNoToAll);
            SetButtonText(Data, IDYES, SMsgDlgYes);
            SetButtonText(Data, IDNO, SMsgDlgNO);
            SetButtonText(Data, IDCANCEL, SMsgDlgCancel);
            SetButtonText(Data, IDHELP, SMsgDlgHelp);
...
begin
  ...
  if ADialogType <> TMsgDlgType.mtCustom then
    Params.lpszCaption := PChar(MsgCaptions[ADialogType])
  else
